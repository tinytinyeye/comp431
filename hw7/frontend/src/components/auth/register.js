...
const Register = ( { validate } ) => {
    let username, email, zipcode, pwd, pwdConfirm;
    ...
    return (
		<div className="col-sm-6 col-md-6">
          ...
          validate(username.value, email.value, 
            zipcode.value, pwd.value, pwdConfirm.value)
          }}>
...
export default connect(null, (dispatch) => {
  return {
    validate: (username, email, zipcode, pwd, pwdConfirm) =>
    dispatch(validate(username, email, zipcode, pwd, pwdConfirm))
  }
})(Register)